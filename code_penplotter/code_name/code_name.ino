...
void loop() {
  ...
  if (Serial.available()) {
    ...
    if (command == "START" && !emergencyTriggered) {
    ...
    else if (command == "NAME" && !emergencyTriggered) {
      emergencyHandled = false;  // Allow emergency again after START
      Serial.println("Sequence started");
      ...
      moveX(0.5, false);
      moveDiagonal(0.5, true, 0.5, true);
      moveX(0.5, false);
      ...
      moveY(0.1, true);
      penDown();
      moveDiagonal(0.45,true, 0.45, false);
      moveDiagonal(0.45,true, 0.45, true);
      penUp();
      moveDiagonal(0.29,false, 0.25, false);
      penDown();
      ...
      penUp();
      moveY(0.33,true);
      moveDiagonal(0.30,true, 0.25, true);
      moveX(0.5, false);
      penDown();
      //moveX(0.5, false);
      moveX(0.5,true);
